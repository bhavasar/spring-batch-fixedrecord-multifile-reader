 ...
 */
public class ContraRecordFieldSetMapper implements FieldSetMapper<ContraRecord> {

	public ContraRecord mapFieldSet(FieldSet fieldSet) {
		ContraRecord trans = new ContraRecord();
